...
- 將幼兒園與安親班拆成兩套獨立操作章節，分別說明服務定位、建課、老師回報、園所端、每日檢查與注意事項。
- 更新幼兒園流程：課內人數免填、課程成果、多張活動照片、課程進度、評分、學期評量與證書。
- 更新安親班流程：運動班長品牌、6 位數驗證、預計／實到人數、暑期匯入、主教／助教、課後評分與成果分享。
- 將「LINE 通知」更新為「客服通知中心」，補充批次收件人、範本、變數預覽、確認收到、綁定與發送紀錄。
- 更新老師請假：行政可代建請假，代課候選人會排除衝堂及前後堂無法趕場者。
- 更新老師管理：助教費用可直接輸入，薪資依每堂課實際主教／助教角色計算。
- 更新週課表與出勤說明：清楚區分預計人數與實到人數。
- 新增「器材管理」章節：器材照片、狀態、數量、備註與搜尋。
- 新增「園所端與課程評分」章節，補充幼兒園／安親班品牌及功能差異。
- 更新角色工作清單與 FAQ，重新產生 HTML 與 PDF 並完成逐頁版面檢查。
