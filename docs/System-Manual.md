...
本手冊依據目前系統頁面、路由、表單欄位、API 規則與實際截圖產生。截圖取自本機系統 `http://127.0.0.1:3000`，日期為 2026-07-11。截圖標示說明：① 搜尋區、② 篩選區、③ 新增按鈕、④ 匯出按鈕；若該頁沒有對應功能，章節會註明「本頁未提供」。
...
目前系統另有「課程進度」「代課紀錄」「器材管理」「帳號管理」「園所端入口」等延伸頁面。老師可在 LINE 申請本月與下月課程請假；園所可從園所端提出日期、時間、地點、人數或停課異動。指定手冊章節中的「系統設定」以帳號管理為主，其他延伸功能會在相關注意事項中提示。
...
老師請假集中處理老師從 LINE 提出的請假申請、行政審核、代課候選人詢問與正式代課確認。老師可選擇本月與下月已建立出勤的課程，並須填寫請假原因。

【操作步驟】

Step 1：老師在 LINE 輸入「請假」或「申請請假」，選擇課程並填寫原因。  
Step 2：行政進入「老師請假」，以年月與狀態篩選申請。  
Step 3：確認課程、角色、原因與本學期累計請假次數後，核准或駁回。  
...
已鎖薪的課程不可發送代課詢問或更換代課。老師可在 LINE 取消尚未完成代課安排的請假；若已找到代課，需聯絡行政處理。代課老師若取消已確認的代課，系統會通知行政並建立高優先異常。
...
Q：老師如何申請請假？  
A：老師在 LINE 輸入「請假」或「申請請假」，選擇本月或下月的課程並填寫原因。行政需在「老師請假」核准後，才會進入代課安排。
