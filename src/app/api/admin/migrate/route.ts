...
export async function POST(req: NextRequest) {
  ...
  const migrations = [
    ...
    'CREATE TABLE IF NOT EXISTS LineConversationState (lineUserId TEXT NOT NULL, action TEXT NOT NULL, referenceId INTEGER NOT NULL, payload TEXT NOT NULL DEFAULT \'\', expiresAt DATETIME NOT NULL, createdAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updatedAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (lineUserId, action))',
    'CREATE TABLE IF NOT EXISTS AttendanceSheetSync (attendanceId INTEGER NOT NULL PRIMARY KEY, status TEXT NOT NULL DEFAULT "待同步", sheetName TEXT NOT NULL DEFAULT "", cell TEXT NOT NULL DEFAULT "", systemValue INTEGER, sheetValue TEXT NOT NULL DEFAULT "", message TEXT NOT NULL DEFAULT "", attempts INTEGER NOT NULL DEFAULT 0, lastAttemptAt DATETIME, syncedAt DATETIME, createdAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updatedAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)',
