          ...
          <div className="px-5 py-6 text-white sm:px-7 relative" style={{ background: `linear-gradient(135deg, ${palette.fg} 0%, ${palette.fg}CC 100%)` }}>
            ...
            {rows.length > 0 && (
              <button
                ...
                className="mt-4 inline-flex items-center gap-1.5 rounded-lg bg-white/20 px-3 py-1.5 text-sm font-medium hover:bg-white/30 backdrop-blur-sm transition-colors sm:absolute sm:right-7 sm:top-6 sm:mt-0"
              >
